            ...
            cartItemsContainer.innerHTML += `
                <div class="card mb-3">
                    <div class="card-body d-flex gap-4">
                        <img src="<?php echo e(asset('path/to/your/image')); ?>" alt="${item.name}" width="200" height="200">
...
<?php echo $__env->make('user.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce_App\resources\views/user/page/keranjang.blade.php ENDPATH**/ ?>