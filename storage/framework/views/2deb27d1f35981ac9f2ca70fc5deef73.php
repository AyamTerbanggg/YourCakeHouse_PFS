                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control-plaintext" id="SKU" name="sku"
                                value="<?php echo e($data->sku); ?>" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="nameProduct" name="nama"
                                value="<?php echo e($data->nama_product); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="birthday" <?php echo e($data->type === 'birthday' ? 'selected' : ''); ?>>Birthday</option>
                                <option value="cupcakes" <?php echo e($data->type === 'cupcakes' ? 'selected' : ''); ?>>Cupcakes</option>
                                <option value="layerCake" <?php echo e($data->type === 'layerCake' ? 'selected' : ''); ?>>Layer Cake
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="BirthdayCake" <?php echo e($data->kategory === 'BirthdayCake' ? 'selected' : ''); ?>>Birthday Cake</option>
                                <option value="Pastries&Desserts" <?php echo e($data->kategory === 'Pastries&Desserts' ? 'selected' : ''); ?>>Pastries & Desserts
                                </option>
                                <option value="LayerCakes" <?php echo e($data->kategory === 'LayerCakes' ? 'selected' : ''); ?>>
                                Layer Cakes</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" class="form-control" id="quantity" name="quantity"
                                value="<?php echo e($data->quantity); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
...
</script><?php /**PATH C:\xampp\htdocs\Ecommerce_App\resources\views/admin/modal/editModal.blade.php ENDPATH**/ ?>