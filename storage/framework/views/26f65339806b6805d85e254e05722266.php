...
<main>
    ...
    <div id="bannerCarousel" class="carousel slide mt-0" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('asset/jumbotron1.svg')); ?>" class="d-block w-100" alt="Slide 1">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('asset/jumbotron2.svg')); ?>" class="d-block w-100" alt="Slide 2">
            </div>
        </div>
    ...
    <div class="main-content px-5 pt-4" style="color: #493628">
        <div class="highlight shadow hover-card">
            <img alt="Strawberry Cupcakes" height="300" src="<?php echo e(asset('asset/4.jpeg')); ?>" width="500" class="hover-effect" />
            <div class="text px-5">
    ...
    <div class="row px-5 pt-4" style="color: #493628">
        <div class="col-md-3 mb-4">
            <div class="card shadow hover-card">
                <img alt="Birthday Cake" src="<?php echo e(asset('asset/1.jpeg')); ?>" class="card-img-top hover-effect" />
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow hover-card">
                <img alt="Cheesecake" src="<?php echo e(asset('asset/9.jpeg')); ?>" class="card-img-top hover-effect" />
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow hover-card">
                <img alt="Brownies" src="<?php echo e(asset('asset/12.jpeg')); ?>" class="card-img-top hover-effect" />
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow hover-card">
                <img alt="Oreo Cupcakes" src="<?php echo e(asset('asset/8.jpeg')); ?>" class="card-img-top hover-effect" />
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
...
<?php echo $__env->make('user.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce_App\resources\views/user/page/home.blade.php ENDPATH**/ ?>