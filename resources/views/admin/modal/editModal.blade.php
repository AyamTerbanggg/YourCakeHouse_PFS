                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="cupcakes" {{ $data->type === 'cupcakes' ? 'selected' : '' }}>Cupcakes</option>
                                <option value="layerCake" {{ $data->type === 'layerCake' ? 'selected' : '' }}>Layer Cake
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="BirthdayCake" {{ $data->kategory === 'BirthdayCake' ? 'selected' : '' }}>Birthday Cake</option>
                                <option value="Pastries&Desserts" {{ $data->kategory === 'Pastries&Desserts' ? 'selected' : '' }}>Pastries & Desserts
                                </option>
                                <option value="LayerCakes" {{ $data->kategory === 'LayerCakes' ? 'selected' : '' }}>
                                Layer Cakes</option>
                            </select>
                        </div>
                    </div>
