<aside
        class="sidebar navbar navbar-expand-lg d-flex flex-column gap-4 align-content-lg-center mx-1 my-2 rounded" style="background-color: #493628">
        <h5 class="navbar-brand">Cake House</h5>
            ...
            <ul class="navbar-nav flex-column gap-3 px-2">
                ...
                <li class="navbar-item">
                    <form action="{{ route('logout') }}" method="POST" class="m-0 p-0">
                        @csrf
                        <button type="submit" class="btn text-white d-flex align-items-center gap-3" style="background: none; border: none; cursor: pointer;">
